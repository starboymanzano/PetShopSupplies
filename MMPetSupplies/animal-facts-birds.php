...
<html lang="en">
<head>
	<title>M&M - Animal Facts: Birds</title>
	<meta charset="utf-8">
		...
		<div class="row">
				...
				<div class="margin-panel panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="page-header">
							<center><h2>🐱 Bird Facts 🐱</h2></center>
						</div>
					</div>
					<p><img class="img-responsive thumbnail" src="media/birds.jpg"/></p>
			...
			<div class="col-lg-2">
				<div class="list-group">
					...
					<a href="animal-facts-birds.php" class="list-group-item active">
